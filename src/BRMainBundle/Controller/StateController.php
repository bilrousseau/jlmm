...
class StateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $states = $em->getRepository('BRMainBundle:State')->findAll();
    ...
    {
        $state = new State();
        $form = $this->createForm('BRMainBundle\Form\StateType', $state);
    ...
    {
        $deleteForm = $this->createDeleteForm($state);
        $editForm = $this->createForm('BRMainBundle\Form\StateType', $state);
